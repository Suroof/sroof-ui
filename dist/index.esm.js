...
const Button = ({ children, variant = "primary", size = "medium", rounded = "medium", onClick, disabled = false, className = "", }) => {
    const buttonClasses = [
        styles$i.button,
        styles$i[`button-${variant}`],
        styles$i[`button-${size}`],
        styles$i[`button-rounded-${rounded}`],
...
var styles$h = {"input-text":"Input-module_input-text__XcNOB","disabled":"Input-module_disabled__nzcnQ","input-small":"Input-module_input-small__9GUx7","input-medium":"Input-module_input-medium__l3uKK","input-large":"Input-module_input-large__cGDd5"};
...
var styles$g = {"dropdown":"LanguageSwitcher-module_dropdown__LT1O-","select":"LanguageSwitcher-module_select__LL4YO","buttonGroup":"LanguageSwitcher-module_buttonGroup__YWhtE","indicator":"LanguageSwitcher-module_indicator__RN9Va","languageButton":"LanguageSwitcher-module_languageButton__ZUCZN","active":"LanguageSwitcher-module_active__7Npr-"};
...
const MenuItem = ({ children, className = "", onClick, disabled = false, icon, isActive = false, mode = "horizontal", theme = "light", danger = false, }) => {
    ...
    return (jsxRuntimeExports.jsxs("li", { className: itemClasses, onClick: handleClick, onKeyDown: handleKeyDown, role: "menuitem", tabIndex: disabled ? -1 : 0, "aria-disabled": disabled, "aria-current": isActive ? 'page' : undefined, children: [icon && jsxRuntimeExports.jsx("span", { className: styles$f.icon, children: icon }), jsxRuntimeExports.jsx("span", { className: styles$f.label, children: children })] }));
};
// 子菜单组件
const SubMenu = ({ children, title, className = "", itemKey, icon, disabled = false, isActive = false, isOpen = false, onItemSelect, onToggle, mode = "horizontal", theme = "light", expandIcon, }) => {
    ...
    const subMenuClasses = [
        styles$f.subMenu,
        isOpen && styles$f.open,
        isActive && styles$f.active,
        disabled && styles$f.disabled,
        styles$f[`submenu-${mode}`],
        styles$f[`submenu-${theme}`],
        className
    ].filter(Boolean).join(" ");
    const handleToggle = () => {
    ...
    return (jsxRuntimeExports.jsxs("li", { className: subMenuClasses, children: [jsxRuntimeExports.jsxs("div", { className: styles$f.subMenuTitle, onClick: handleToggle, onKeyDown: handleKeyDown, role: "menuitem", tabIndex: disabled ? -1 : 0, "aria-disabled": disabled, "aria-expanded": isOpen, "aria-haspopup": "menu", children: [icon && jsxRuntimeExports.jsx("span", { className: styles$f.icon, children: icon }), jsxRuntimeExports.jsx("span", { className: styles$f.label, children: title }), jsxRuntimeExports.jsx("span", { className: styles$f.arrow, children: expandIcon || defaultExpandIcon })] }), jsxRuntimeExports.jsx("ul", { ref: subMenuRef, className: styles$f.subMenuList, style: { maxHeight }, role: "menu", "aria-hidden": !isOpen, children: renderSubMenuItems() })] }));
};

var styles$e = {"tabs-container":"Tabs-module_tabs-container__U9u1K","tabs":"Tabs-module_tabs__QzIkz","tab":"Tabs-module_tab__IdDYc","active":"Tabs-module_active__PTNtG","content":"Tabs-module_content__A4evF"};
...
const Tabs = ({ activeKey, children, className, defaultActiveKey, onChange, }) => {
    ...
    return (jsxRuntimeExports.jsxs("div", { className: `${styles$e['tabs-container']} ${className || ""}`, children: [jsxRuntimeExports.jsx("div", { className: styles$e.tabs, children: tabs.map((tab) => (jsxRuntimeExports.jsx("div", { className: `${styles$e.tab} ${tab.key === currentActiveKey ? styles$e.active : ""}`, onClick: () => handleTabClick(tab.key), children: tab.props.label }, tab.key))) }), jsxRuntimeExports.jsx("div", { className: styles$e.content, children: activeTab && activeTab.props.children })] }));
};

var styles$d = {"radio":"Radio-module_radio__MfgN-","disabled":"Radio-module_disabled__0-cna","label":"Radio-module_label__vAFIP","radioGroup":"Radio-module_radioGroup__W9xve","vertical":"Radio-module_vertical__WksGU","horizontal":"Radio-module_horizontal__1Ovgu"};
...
const Radio = ({ children, value, disabled = false, checked, defaultChecked = false, name, onChange, className, }) => {
    ...
    return (jsxRuntimeExports.jsxs("label", { className: `${styles$d.radio} ${disabled ? styles$d.disabled : ""} ${className || ""}`, htmlFor: radioId, children: [jsxRuntimeExports.jsx("input", { id: radioId, type: "radio", value: value, checked: isChecked, disabled: disabled, name: name, onChange: handleChange }), jsxRuntimeExports.jsx("span", { className: styles$d.label, children: children })] }));
};
...
const Switch = ({ checked, defaultChecked = false, disabled = false, onChange, className, size = 'medium', children, labelPosition = 'right', loading = false, color, }) => {
    ...
    const switchElement = (jsxRuntimeExports.jsxs("label", { className: `${styles$c.switch} ${styles$c[size]} ${disabled ? styles$c.disabled : ''} ${loading ? styles$c.loading : ''} ${className || ''}`, htmlFor: switchId, children: [jsxRuntimeExports.jsx("input", { id: switchId, type: "checkbox", checked: isChecked, disabled: disabled || loading, onChange: handleChange, className: styles$c.input, role: "switch", "aria-checked": isChecked ? "true" : "false", "aria-disabled": disabled || loading ? "true" : "false" }), jsxRuntimeExports.jsx("span", { className: styles$c.slider, style: color && isChecked ? { backgroundColor: color } : undefined, children: loading && jsxRuntimeExports.jsx("span", { className: styles$c.spinner }) })] }));
    if (children) {
        return (jsxRuntimeExports.jsxs("div", { className: `${styles$c.switchWrapper} ${styles$c[`label-${labelPosition}`]}`, children: [labelPosition === 'left' && (jsxRuntimeExports.jsx("span", { className: styles$c.label, children: children })), switchElement, labelPosition === 'right' && (jsxRuntimeExports.jsx("span", { className: styles$c.label, children: children }))] }));
    }
    return switchElement;
};

var styles$b = {"form":"Form-module_form__jNBDR","bordered":"Form-module_bordered__kBopT","vertical":"Form-module_vertical__kme69","formItem":"Form-module_formItem__R7Y1M","horizontal":"Form-module_horizontal__obPd4","label":"Form-module_label__eeQ-m","inline":"Form-module_inline__LBQAv","small":"Form-module_small__AYGfB","medium":"Form-module_medium__10nxr","large":"Form-module_large__mbQ50","error":"Form-module_error__tGSoc","control":"Form-module_control__SeA--","required":"Form-module_required__V5rxn","errorMessage":"Form-module_errorMessage__iI97c","slideInDown":"Form-module_slideInDown__cmiaE","pulse":"Form-module_pulse__qE0es","helpText":"Form-module_helpText__fIhhQ","formActions":"Form-module_formActions__bHjHX","align-left":"Form-module_align-left__kIYC7","align-center":"Form-module_align-center__xH6DF","align-right":"Form-module_align-right__3CC5U","fadeInUp":"Form-module_fadeInUp__O640y"};

const FormItem = ({ label, required = false, error, help, className, children, labelPosition = 'top', }) => {
    const itemId = React.useId();
    return (jsxRuntimeExports.jsxs("div", { className: `${styles$b.formItem} ${styles$b[`label-${labelPosition}`]} ${error ? styles$b.error : ''} ${className || ''}`, children: [label && (jsxRuntimeExports.jsxs("label", { htmlFor: itemId, className: styles$b.label, children: [label, required && jsxRuntimeExports.jsx("span", { className: styles$b.required, children: "*" })] })), jsxRuntimeExports.jsx("div", { className: styles$b.control, children: React.Children.map(children, (child) => {
                    if (React.isValidElement(child)) {
                    ...
                    return child;
                }) }), error && (jsxRuntimeExports.jsx("div", { id: `${itemId}-error`, className: styles$b.errorMessage, role: "alert", children: error })), help && !error && (jsxRuntimeExports.jsx("div", { id: `${itemId}-help`, className: styles$b.helpText, children: help }))] }));
};
...
const Card = ({ title, children, className, size = "medium", type = "default", clickable = false, onClick, bordered = true, shadow = "md", icon, actions, loading = false, }) => {
    const cardClasses = [
        ...
        styles$a[size],
        styles$a[type],
        bordered ? styles$a.bordered : styles$a.borderless,
        styles$a[`shadow-${shadow}`],
        clickable ? styles$a.clickable : '',
        loading ? styles$a.loading : '',
        className || ''
    ].filter(Boolean).join(' ');
    return (jsxRuntimeExports.jsxs("div", { className: cardClasses, onClick: clickable ? onClick : undefined, role: clickable ? "button" : undefined, tabIndex: clickable ? 0 : undefined, children: [loading && jsxRuntimeExports.jsx("div", { className: styles$a.loadingOverlay, children: jsxRuntimeExports.jsx("div", { className: styles$a.spinner }) }), (title || icon || actions) && (jsxRuntimeExports.jsxs("div", { className: styles$a.header, children: [jsxRuntimeExports.jsxs("div", { className: styles$a.titleSection, children: [icon && jsxRuntimeExports.jsx("div", { className: styles$a.icon, children: icon }), title && jsxRuntimeExports.jsx("div", { className: styles$a.title, children: title })] }), actions && jsxRuntimeExports.jsx("div", { className: styles$a.actions, children: actions })] })), jsxRuntimeExports.jsx("div", { className: styles$a.content, children: children })] }));
};

var styles$9 = {"pagination":"Pagination-module_pagination__icb-v","pageButton":"Pagination-module_pageButton__AL1wT","disabled":"Pagination-module_disabled__x47WD","active":"Pagination-module_active__1kqsJ","prevButton":"Pagination-module_prevButton__MAF64","nextButton":"Pagination-module_nextButton__-k5WS","dots":"Pagination-module_dots__Yl9da"};
...
const Drawer = ({ open, onClose, title, children, placement = 'right', size = 'default', theme = 'light', closable = true, maskClosable = true, footer, className, closeIcon, afterOpenChange, }) => {
    ...
    const drawerClasses = [
        styles$8.drawer,
        styles$8[`drawer-${placement}`],
        styles$8[`drawer-${theme}`],
        size !== 'default' && styles$8[`drawer-${size}`],
        styles$8[animationState],
        className
    ].filter(Boolean).join(' ');
    ...
    const drawerContent = (jsxRuntimeExports.jsx("div", { className: overlayClasses, onClick: handleMaskClick, children: jsxRuntimeExports.jsxs("div", { ref: drawerRef, className: drawerClasses, onClick: handleDrawerClick, role: "dialog", "aria-modal": "true", "aria-labelledby": title ? 'drawer-title' : undefined, children: [(title || closable) && (jsxRuntimeExports.jsxs("div", { className: styles$8.header, children: [title && (jsxRuntimeExports.jsx("h3", { id: "drawer-title", className: styles$8.title, children: title })), closable && (jsxRuntimeExports.jsx("button", { className: styles$8.closeButton, onClick: onClose, "aria-label": "\u5173\u95ED\u62BD\u5C49", children: closeIcon || (jsxRuntimeExports.jsx("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "currentColor", children: jsxRuntimeExports.jsx("path", { d: "M8 7.293l2.146-2.147a.5.5 0 01.708.708L8.707 8l2.147 2.146a.5.5 0 01-.708.708L8 8.707l-2.146 2.147a.5.5 0 01-.708-.708L7.293 8 5.146 5.854a.5.5 0 01.708-.708L8 7.293z" }) })) }))] })), jsxRuntimeExports.jsx("div", { className: styles$8.content, children: children }), footer && (jsxRuntimeExports.jsx("div", { className: styles$8.footer, children: footer }))] }) }));
    return createPortal(drawerContent, document.body);
};

var styles$7 = {"notification":"Notification-module_notification__WfYqO","top-left":"Notification-module_top-left__-uozQ","top-right":"Notification-module_top-right__S3dv9","bottom-left":"Notification-module_bottom-left__kstSy","bottom-right":"Notification-module_bottom-right__4cvNX","content":"Notification-module_content__xt6uE","close":"Notification-module_close__FllIm"};
...
message = "", onClick, onClose, position = "top-right", className, show, }) => {
    ...
    const notificationClass = [styles$7.notification, styles$7[position], className]
        .filter(Boolean)
        .join(" ");
    return (jsxRuntimeExports.jsxs("div", { className: notificationClass, children: [jsxRuntimeExports.jsx("div", { className: styles$7.content, onClick: onClick, children: message }), jsxRuntimeExports.jsx("button", { className: styles$7.close, onClick: handleClose, "aria-label": "\u5173\u95ED\u901A\u77E5", children: closeIcon || "×" })] }));
};

var styles$6 = {"carouselContainer":"Carousel-module_carouselContainer__U7uvv","carouselWrapper":"Carousel-module_carouselWrapper__mbMz6","carouselItem":"Carousel-module_carouselItem__azNhm","navButton":"Carousel-module_navButton__MF8Tr","prevButton":"Carousel-module_prevButton__GnvyX","nextButton":"Carousel-module_nextButton__2O6P1","dotsContainer":"Carousel-module_dotsContainer__GSKvc","dot":"Carousel-module_dot__9O4Is","active":"Carousel-module_active__3sD6-"};
...
const Carousel = ({ items, autoplayInterval = 3000, }) => {
    ...
    useEffect(() => {
        ...
        // 监听过渡结束事件
        const carouselWrapper = document.querySelector(`.${styles$6.carouselWrapper}`);
    ...
    return (jsxRuntimeExports.jsxs("div", { className: styles$6.carouselContainer, onMouseEnter: stopAutoplay, onMouseLeave: startAutoplay, children: [jsxRuntimeExports.jsx("div", { ref: carouselWrapperRef, className: styles$6.carouselWrapper, style: {
                    transform: `translateX(-${currentIndex * 100}%)`,
                    transition: isTransitioning ? "transform 0.5s ease-in-out" : "none",
                }, children: displayItems.map((item, index) => (jsxRuntimeExports.jsx("div", { className: styles$6.carouselItem, children: jsxRuntimeExports.jsx("img", { src: item.imageUrl, alt: item.altText }) }, index))) }), jsxRuntimeExports.jsx("button", { onClick: prevSlide, className: `${styles$6.navButton} ${styles$6.prevButton}`, children: "\u276E" }), jsxRuntimeExports.jsx("button", { onClick: nextSlide, className: `${styles$6.navButton} ${styles$6.nextButton}`, children: "\u276F" }), jsxRuntimeExports.jsx("div", { className: styles$6.dotsContainer, children: items.map((_, index) => {
                    // 计算当前激活的指示点
                    ...
                    if (currentIndex === displayItems.length - 1)
                        activeIndex = 0;
                    return (jsxRuntimeExports.jsx("span", { className: `${styles$6.dot} ${index === activeIndex ? styles$6.active : ""}`, onClick: () => setCurrentIndex(index + 1) }, index));
                }) })] }));
};

var styles$5 = {"collapse":"Collapse-module_collapse__Y5Z0-","panel":"Collapse-module_panel__Cnkt2","panelHeader":"Collapse-module_panelHeader__SrY-h","disabled":"Collapse-module_disabled__rJXNh","headerText":"Collapse-module_headerText__UjUGH","panelIcon":"Collapse-module_panelIcon__EaG7O","active":"Collapse-module_active__4ckAf","panelContent":"Collapse-module_panelContent__sgsTH","contentBox":"Collapse-module_contentBox__a-w2g","contentEnter":"Collapse-module_contentEnter__3yfeM","contentEnterActive":"Collapse-module_contentEnterActive__RsLBp","contentExit":"Collapse-module_contentExit__K3wJY","contentExitActive":"Collapse-module_contentExitActive__wMxKn"};
...
const InternalPanel = ({ panelKey, header, disabled, children }) => {
    ...
    const headerClasses = `${styles$5.panelHeader} ${disabled ? styles$5.disabled : ''}`;
    const iconClasses = `${styles$5.panelIcon} ${isActive ? styles$5.active : ''}`;
    return (jsxRuntimeExports.jsxs("div", { className: styles$5.panel, children: [jsxRuntimeExports.jsxs("button", { className: headerClasses, onClick: () => !disabled && onToggle(panelKey), "aria-expanded": isActive, children: [jsxRuntimeExports.jsx("span", { className: styles$5.headerText, children: header }), jsxRuntimeExports.jsx("span", { className: iconClasses, children: jsxRuntimeExports.jsx("svg", { viewBox: "0 0 1024 1024", width: "1em", height: "1em", fill: "currentColor", children: jsxRuntimeExports.jsx("path", { d: "M765.7 486.8L314.9 134.7A7.97 7.97 0 00302 141v77.3c0 4.9 2.3 9.6 6.1 12.6l360 281.1-360 281.1c-3.9 3-6.1 7.7-6.1 12.6V883c0 6.7 7.7 10.4 12.9 6.3l450.8-352.1a31.96 31.96 0 000-50.4z" }) }) })] }), jsxRuntimeExports.jsx(CSSTransition, { nodeRef: contentRef, in: isActive, timeout: 300, classNames: {
                    enter: styles$5.contentEnter,
                    enterActive: styles$5.contentEnterActive,
                    exit: styles$5.contentExit,
                    exitActive: styles$5.contentExitActive,
                }, unmountOnExit: true, children: jsxRuntimeExports.jsx("div", { ref: contentRef, className: styles$5.panelContent, children: jsxRuntimeExports.jsx("div", { className: styles$5.contentBox, children: children }) }) })] }));
};
...
const ScrollCard = ({ items, speed = 40, cardWidth = 400, }) => {
    ...
    return (jsxRuntimeExports.jsx("div", { className: styles$4.componentRoot, style: componentStyle, children: jsxRuntimeExports.jsx("div", { className: styles$4.scrollContainer, children: jsxRuntimeExports.jsx("div", { className: styles$4.scrollWrapper, children: displayItems.map((item, index) => (jsxRuntimeExports.jsxs("div", { className: styles$4.card, children: [jsxRuntimeExports.jsx("img", { src: item.imageUrl, alt: typeof item.title === 'string' ? item.title : '', className: styles$4.cardImage }), jsxRuntimeExports.jsxs("div", { className: styles$4.cardContent, children: [jsxRuntimeExports.jsx("h3", { className: styles$4.cardTitle, children: item.title }), item.description && jsxRuntimeExports.jsx("p", { className: styles$4.cardDescription, children: item.description })] })] }, `${item.id}-${index}`))) }) }) }));
};

var styles$3 = {"scrollRevealContainer":"ScrollReveal-module_scrollRevealContainer__q7eR-","isVisible":"ScrollReveal-module_isVisible__u0Ja2","revealChild":"ScrollReveal-module_revealChild__JxjN7","revealed":"ScrollReveal-module_revealed__nd8Um","from-up":"ScrollReveal-module_from-up__FRFYN","from-down":"ScrollReveal-module_from-down__KNCIt","from-left":"ScrollReveal-module_from-left__ydBwD","from-right":"ScrollReveal-module_from-right__U922Z"};
...
const ScrollReveal = ({ children, threshold = 0.1, staggerDelay = 150, as: Component = "div", direction = "up", distance = 20, }) => {
    ...
    const childrenWithStagger = Children.map(children, (child, index) => {
        ...
        if (isValidElement(child)) {
            ...
            const childProps = {
                className: `${existingClassName} ${styles$3.revealChild} ${isAnimated ? styles$3.revealed : ""}`.trim(),
            };
    ...
    ${styles$3.scrollRevealContainer}
    ${isVisible ? styles$3.isVisible : ""}
    ${styles$3[`from-${direction}`]}
  `;
...
const LinearProgress = ({ progress, size = "medium", color, showPercentage = true, striped = false, }) => {
    ...
    const trackClasses = `${styles$2.linearTrack} ${styles$2[`linear-${size}`]}`;
    const barClasses = `${styles$2.linearBar} ${striped ? styles$2.striped : ''}`;
    return (jsxRuntimeExports.jsxs("div", { className: styles$2.linearContainer, children: [jsxRuntimeExports.jsx("div", { className: trackClasses, children: jsxRuntimeExports.jsx("div", { className: barClasses, style: barStyle }) }), showPercentage && (jsxRuntimeExports.jsxs("span", { className: styles$2.percentageText, children: [Math.round(displayProgress), "%"] }))] }));
};
// 内部的圆形进度条组件
const CircularProgress = ({ progress, size = "medium", color, showPercentage = true, }) => {
    ...
    const containerClasses = `${styles$2.circularContainer} ${styles$2[`circular-${size}`]}`;
    return (jsxRuntimeExports.jsxs("div", { className: containerClasses, children: [jsxRuntimeExports.jsxs("svg", { className: styles$2.circularSvg, viewBox: "0 0 100 100", children: [jsxRuntimeExports.jsx("circle", { className: styles$2.circularTrack, cx: "50", cy: "50", r: radius }), jsxRuntimeExports.jsx("circle", { className: styles$2.circularBar, cx: "50", cy: "50", r: radius, strokeDasharray: circumference, style: barStyle })] }), showPercentage && (jsxRuntimeExports.jsxs("span", { className: styles$2.percentageTextCircular, children: [Math.round(displayProgress), "%"] }))] }));
};
// 主进度条组件
const Progress = (_a) => {
    ...
    return (jsxRuntimeExports.jsx("div", { className: `${styles$2.progressWrapper} ${className}`, role: "progressbar", "aria-valuenow": rest.progress, children: jsxRuntimeExports.jsx(Component, Object.assign({}, rest)) }));
};
...
var styles$1 = {"float":"Float-module_float__Xkuud"};
...
const Float = ({ duration = 3, delay = 0, className = "", children }) => {
    ...
    return (jsxRuntimeExports.jsx("div", { ref: elementRef, className: `${styles$1.float} ${className}`, children: children }));
};
...
var styles = {"container":"EmergeText-module_container__7wPn1","animateMe":"EmergeText-module_animateMe__WI9rM","srOnly":"EmergeText-module_srOnly__72xsu"};
...
const EmergeText = ({ text, duration = 0.8, stagger = 0.05, y = 20, splitType = "words", className, }) => {
    ...
    return (
    //既保留默认样式也支持用户自定义样式
    jsxRuntimeExports.jsxs("div", { className: `${styles.container} ${className}`, ref: containerRef, children: [jsxRuntimeExports.jsx("div", { className: styles.animateMe, ref: animateRef, "aria-hidden": "true", "data-split-type": splitType, children: text }), jsxRuntimeExports.jsx("p", { className: styles.srOnly, children: text })] }));
};
