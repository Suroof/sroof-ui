...
const Button = ({ children, variant = "primary", size = "medium", onClick, disabled = false, className = "", }) => {
    const buttonClasses = [
        ...
        .filter(Boolean)
        .join(" ");
    return (jsx("button", { className: buttonClasses, onClick: onClick, disabled: disabled, type: "button", children: children }));
};
...
const LanguageSwitcher = ({ className, variant = 'dropdown', }) => {
    ...
    if (variant === 'buttons') {
        return (jsxs("div", { ref: containerRef, className: `${styles$6.buttonGroup} ${className || ''}`, children: [jsx("div", { className: styles$6.indicator, style: indicatorStyle }), languageEntries.map(([code, name]) => (jsx("button", { className: `${styles$6.languageButton} ${currentLanguage === code ? styles$6.active : ''}`, onClick: () => handleLanguageChange(code), type: "button", children: name }, code)))] }));
    }
    return (jsx("div", { className: `${styles$6.dropdown} ${className || ''}`, children: jsx("select", { value: currentLanguage, onChange: (e) => handleLanguageChange(e.target.value), className: styles$6.select, children: Object.entries(supportedLanguages).map(([code, name]) => (jsx("option", { value: code, children: name }, code))) }) }));
};
...
const Menu = ({ children, className = "", mode = "horizontal", defaultSelectedKey = "", onSelect, theme = "light", }) => {
    ...
    return jsx("ul", { className: menuClasses, children: renderMenuItems(children) });
};
const MenuItem = ({ label, isActive = false, onClick, disabled = false, icon, }) => {
    ...
    return (jsx("li", { className: `${styles$5.menuItem} ${isActive ? styles$5.menuItemActive : ""} ${disabled ? styles$5.menuItemDisabled : ""}`, onClick: handleClick, onKeyDown: handleKeyDown, role: "menuitem", tabIndex: disabled ? -1 : 0, "aria-disabled": disabled, children: jsxs("div", { className: styles$5.menuItemContent, children: [icon && jsx("span", { className: styles$5.menuItemIcon, children: icon }), jsx("span", { className: styles$5.menuItemLabel, children: label }), isActive && jsx("div", { className: styles$5.activeIndicator })] }) }));
};
const SubMenu = ({ label, children, isActive = false, disabled = false, onItemSelect, icon }) => {
    ...
    return (jsxs("li", { className: `${styles$5.subMenu} ${isActive ? styles$5.subMenuActive : ""} ${disabled ? styles$5.subMenuDisabled : ""} ${isOpen ? styles$5.subMenuOpen : ""}`, onClick: handleToggle, onKeyDown: handleKeyDown, role: "menuitem", tabIndex: disabled ? -1 : 0, "aria-disabled": disabled, "aria-expanded": isOpen, "aria-haspopup": "true", children: [jsxs("div", { className: styles$5.subMenuTrigger, children: [icon && jsx("span", { className: styles$5.subMenuIcon, children: icon }), jsx("span", { className: styles$5.subMenuLabel, children: label }), jsx("span", { className: `${styles$5.subMenuArrow} ${isOpen ? styles$5.subMenuArrowOpen : ""}`, children: "\u25BC" }), isActive && jsx("div", { className: styles$5.activeIndicator })] }), isOpen && (jsx("ul", { className: styles$5.subMenuList, role: "menu", children: renderSubMenuItems() }))] }));
};
...
const Tabs = ({ activeKey, children, className, defaultActiveKey, onChange, }) => {
    ...
    return (jsxs("div", { className: `${styles$4['tabs-container']} ${className || ""}`, children: [jsx("div", { className: styles$4.tabs, children: tabs.map((tab) => (jsx("div", { className: `${styles$4.tab} ${tab.key === currentActiveKey ? styles$4.active : ""}`, onClick: () => handleTabClick(tab.key), children: tab.props.label }, tab.key))) }), jsx("div", { className: styles$4.content, children: activeTab && activeTab.props.children })] }));
};
...
const Radio = ({ children, value, disabled = false, checked, defaultChecked = false, name, onChange, className, }) => {
    ...
    return (jsxs("label", { className: `${styles$3.radio} ${disabled ? styles$3.disabled : ""} ${className || ""}`, htmlFor: radioId, children: [jsx("input", { id: radioId, type: "radio", value: value, checked: isChecked, disabled: disabled, name: name, onChange: handleChange }), jsx("span", { className: styles$3.label, children: children })] }));
};
...
const Switch = ({ checked, defaultChecked = false, disabled = false, onChange, className, size = 'medium', children, labelPosition = 'right', loading = false, color, }) => {
    ...
    const switchElement = (jsxs("label", { className: `${styles$2.switch} ${styles$2[size]} ${disabled ? styles$2.disabled : ''} ${loading ? styles$2.loading : ''} ${className || ''}`, htmlFor: switchId, children: [jsx("input", { id: switchId, type: "checkbox", checked: isChecked, disabled: disabled || loading, onChange: handleChange, className: styles$2.input, role: "switch", "aria-checked": isChecked ? "true" : "false", "aria-disabled": disabled || loading ? "true" : "false" }), jsx("span", { className: styles$2.slider, style: color && isChecked ? { backgroundColor: color } : undefined, children: loading && jsx("span", { className: styles$2.spinner }) })] }));
    if (children) {
        return (jsxs("div", { className: `${styles$2.switchWrapper} ${styles$2[`label-${labelPosition}`]}`, children: [labelPosition === 'left' && (jsx("span", { className: styles$2.label, children: children })), switchElement, labelPosition === 'right' && (jsx("span", { className: styles$2.label, children: children }))] }));
    }
...
const Form = ({ onSubmit, layout = 'vertical', className, children, size = 'medium', bordered = true, }) => {
    ...
    return (jsx("form", { className: `${styles$1.form} ${styles$1[layout]} ${styles$1[size]} ${bordered ? styles$1.bordered : ''} ${className || ''}`, onSubmit: handleSubmit, noValidate: true, children: children }));
};
...
const Card = ({ title, children, className, size = "medium", type = "default", clickable = false, onClick, bordered = true, shadow = "md", icon, actions, loading = false, }) => {
    ...
    return (jsxs("div", { className: cardClasses, onClick: clickable ? onClick : undefined, role: clickable ? "button" : undefined, tabIndex: clickable ? 0 : undefined, children: [loading && jsx("div", { className: styles.loadingOverlay, children: jsx("div", { className: styles.spinner }) }), (title || icon || actions) && (jsxs("div", { className: styles.header, children: [jsxs("div", { className: styles.titleSection, children: [icon && jsx("div", { className: styles.icon, children: icon }), title && jsx("div", { className: styles.title, children: title })] }), actions && jsx("div", { className: styles.actions, children: actions })] })), jsx("div", { className: styles.content, children: children })] }));
};
...
export { Button, Button as ButtonDefault, Card, Card as CardDefault, Form, Form as FormDefault, Input, Input as InputDefault, LanguageSwitcher, LanguageSwitcher as LanguageSwitcherDefault, Menu, Menu as MenuDefault, Radio, Radio as RadioDefault, Switch, Switch as SwitchDefault, Tab, Tabs, Tabs as TabsDefault, formatCurrency, formatDate, formatNumber, getBrowserLanguage, getLanguageNativeName, getSavedLanguage, getTextDirection, instance as i18n, isValidLanguage, saveLanguage, supportedLanguages, tokens, useCurrentLanguage, useLanguageSwitch, useTranslation };
