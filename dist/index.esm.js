...
const LineMotion = (_a) => {
    var { pathData, duration = 2, ease = "power1.inOut", stroke = "black", strokeWidth = 3, autoFit = true, width = "100%", height = "100%" } = _a, props = __rest(_a, ["pathData", "duration", "ease", "stroke", "strokeWidth", "autoFit", "width", "height"]);
    ...
    useLayoutEffect(() => {
        ...
        // 创建动画
        const animation = gsapWithCSS.to(path, {
            strokeDashoffset: 0,
            duration: duration,
            ease: ease,
    ...
    return (jsxRuntimeExports.jsx("svg", Object.assign({}, props, { xmlns: "http://www.w3.org/2000/svg", viewBox: viewBox, children: jsxRuntimeExports.jsx("path", { ref: pathRef, d: pathData, fill: "none", width: width, height: height, stroke: stroke, strokeWidth: strokeWidth, className: styles.wideSvg }) })));
};
