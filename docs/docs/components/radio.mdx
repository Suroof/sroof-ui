...
```jsx
<Radio value="normal">正常状态</Radio>
<Radio value="disabled" disabled>禁用状态</Radio>
<Radio value="disabled-checked" disabled defaultChecked>禁用且选中</Radio>
```
...
```jsx
import { Radio, RadioGroup } from 'sroof-ui';
  ...
  return (
    <div>
      ...
      <RadioGroup value={satisfaction} onChange={setSatisfaction}>
        <Radio value="very-satisfied">非常满意</Radio>
        <Radio value="satisfied">满意</Radio>
        <Radio value="neutral">一般</Radio>
        <Radio value="dissatisfied">不满意</Radio>
        <Radio value="very-dissatisfied">非常不满意</Radio>
      </RadioGroup>
    </div>
  );
}
    ...
    <div>
      <div>
        ...
        <RadioGroup 
          direction="horizontal"
          value={config.layout}
          onChange={(value) => setConfig(prev => ({ ...prev, layout: value }))}
        >
      ...
      <div>
        ...
        <RadioGroup 
          ...
          onChange={(value) => setConfig(prev => ({ ...prev, sorting: value }))}
        >
